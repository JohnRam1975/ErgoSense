...
Integrar os módulos psicossociais/MTE desenvolvidos no protótipo `ergosense_platform_v2.html` ao sistema React/TypeScript existente `ergosense-app`, formando um produto único: **ErgoSense**.
